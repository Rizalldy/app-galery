...
if (isset($_POST['submit'])) {
    ...
    $status = $_POST['status'];
    $post_judul = $_POST['post']; //ambil judul kategori dari form

    // Cari ID kategori berdasarkan judul kategori
    $query_post = "SELECT id FROM posts WHERE judul = '$post_judul'";
    $result_post = mysqli_query($conn, $query_post);
    $row_post = mysqli_fetch_assoc($result_post);
    $post_id = $row_post['id'];

        // Insert the post into the database
        $sql = "INSERT INTO galery (post_id, position, status) VALUES ('$post_id', '$position', '$status')";
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">     
                                ...
                                <input type="int" class="form-control bg-light border-1 small" placeholder="Masukan data" name="position" required>
